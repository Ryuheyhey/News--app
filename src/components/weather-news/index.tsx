...
const WetherNews: FC<Props> = ({ weatherNews }) => {
              ...
              return (
                <li key={index}>
                  ...
                  <div className={styles.weather__temp}>
                    <p className={styles.weather__temp__height}>
                      {parseInt(date.temp.max.toLocaleString(), 10)} ℃
                    </p>
                    <p className={styles.weather__temp__low}>
                      {parseInt(date.temp.min.toLocaleString(), 10)} ℃
                    </p>
                  </div>
                </li>
              );
